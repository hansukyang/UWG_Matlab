function [new_climate_file] = xml_inputs5(CL_EPW_PATH,CL_EPW,CL_XML_PATH,CL_XML)
% =========================================================================
...
%% Param
parameter = Param(xml_input.parameter.daytimeBLHeight,...
    xml_input.parameter.nighttimeBLHeight,...
    xml_input.parameter.refHeight,...
    xml_input.parameter.tempHeight,...
    xml_input.parameter.windHeight,...
    xml_input.parameter.circCoeff,...
    xml_input.parameter.dayThreshold,...
    xml_input.parameter.nightThreshold,...
    xml_input.parameter.treeLatent,...
    xml_input.parameter.grassLatent,...
    xml_input.parameter.vegAlbedo,...
    xml_input.parameter.vegStart,...
    xml_input.parameter.vegEnd,...
    xml_input.parameter.nightSetStart,...
    xml_input.parameter.nightSetEnd,...
    xml_input.parameter.windMin,...
    xml_input.parameter.windMax,...
    xml_input.parameter.wgmax,...
    xml_input.parameter.exCoeff,...
    xml_input.parameter.maxdx,...
