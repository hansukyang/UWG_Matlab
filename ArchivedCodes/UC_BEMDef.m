classdef UCMDef
    ...
    methods
        function obj = UCMDef(bldHeight,bldDensity,verToHor,treeCoverage,sensAnthrop,latAnthrop,...
                initialTemp,initialHum,initialWind,parameter,r_glaze,SHGC,alb_wall,road,rural)
            % class constructor
            if(nargin > 0)
                ...
                obj.facAbsor = (1-r_glaze)*(1-alb_wall)+...
                    r_glaze*(1-0.75*SHGC);
                obj.roadAbsor = (1-road.vegCoverage)*(1-road.albedo)+...
                    road.vegCoverage*(1-rural.albedo);      %?? Not sure why this is here?
                obj.sensHeat = 0.;
            end
        end
    
        function obj = UCModel(obj,ublTemp,urbanUsage,forc,parameter,simTime)
            ...
            Ccan = Cp_air*r_air*(2*wdth_canyon*hght_bld+wdth_bld*hght_bld)/simTime.dt;  
            ...
            % urban air humidity
            Ccan = parameter.lv*r_air*(2*wdth_canyon*hght_bld+wdth_bld*hght_bld)/simTime.dt;  
