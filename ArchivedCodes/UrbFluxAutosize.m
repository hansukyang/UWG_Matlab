function [urbanArea,ublVars,urbanConf,forc,parameter] = UrbFluxAutosize(urbanArea,ublVars,...
    ...
    [urbanConf.road,urbanConf.wall,urbanConf.roof] = InfraCalcs(urbanArea,...
        forc,urbanConf.building.glazingRatio,urbanConf.road,urbanConf.wall,...
        urbanConf.roof,parameter,urbanConf.canWallLWCoef,urbanConf.canRoadLWCoef);

    % builidng energy model
    urbanConf.building = BEM(urbanConf.building,...
        urbanArea,urbanConf.roof,urbanConf.wall,...
        urbanConf.building,urbanConf.mass,forc.pres,parameter,simParam );

    % mass
    urbanConf.mass.layerTemp = Conduction(urbanConf.mass,...
        simParam.dt,urbanConf.building.fluxMass,1,forc.deepTemp,0.);
