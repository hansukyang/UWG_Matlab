function [new_climate_file] = xml_inputs(CL_EPW_PATH,CL_EPW,CL_XML_PATH,CL_XML,CL_RE_PATH,CL_RE)
% =========================================================================
...
if isa(xml_input.typology3.construction.wall.materials.names,'char')
    xml_input.typology3.construction.wall.materials.names = {xml_input.typology3.construction.wall.materials.names};
end
...
if isa(xml_input.typology4.construction.wall.materials.names,'char')
    xml_input.typology4.construction.wall.materials.names = {xml_input.typology4.construction.wall.materials.names};
end
...
simParam = SimParam(...
    ...
    xml_input.parameter.simuStartMonth,...        % Begin month
    xml_input.parameter.simuStartDay,...        % Begin day of the month
    xml_input.parameter.simuDuration);
%     1,...               % Begin month
