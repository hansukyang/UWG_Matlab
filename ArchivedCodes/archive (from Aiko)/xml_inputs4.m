function [new_climate_file] = xml_inputs4(CL_EPW_PATH,CL_EPW,CL_XML_PATH,CL_XML)
% =========================================================================
...
%% Param
parameter = Param(700, 80, 150, 2, 10, 1.2, 200, 50, 0.7, 0.6, 0.25, 1, 12, 17, 8, 0.1, 10, 0.005, 0.3, 500, ...
    9.81, 1004, 0.40, 287, 461.5, 2260000, 3.141592653, 0.0000000567, 1000, 2500800, 273.16, 611.14, 4218,...
    1846.1, 9.4, 7.4, 1.09647471147);

% 
% %Param.dayBLheight = xml_input.referenceSite.latitude;
% parameter = Param();
